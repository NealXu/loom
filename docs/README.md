...
- `handoff/2026-09-05-loom-handoff.md` — 交接文档（P0-P4 全完成后）：201 tests green，功能+增强面闭环，仅剩 git 远程运维
...
- `reports/2026-09-06-final-status.md` — **最终状态报告**：201 tests，全部 P0-P4 闭环，架构全景图 + 使用场景
